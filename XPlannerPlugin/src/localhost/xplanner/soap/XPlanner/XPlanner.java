...
public interface XPlanner extends java.rmi.Remote {
    ...
    public org.xplanner.soap.RoleData[] getRoles() throws java.rmi.RemoteException;
    public org.xplanner.soap.RoleData getRole(int id) throws java.rmi.RemoteException;
    ...
    public boolean isSysAdmin(java.lang.String userId) throws java.rmi.RemoteException;
    ...
    public boolean addRoleProject(int projectId, int personId, int roleId) throws java.rmi.RemoteException;
    public boolean removeRoleProject(int project, int user, int role) throws java.rmi.RemoteException;
}
